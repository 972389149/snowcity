...
$(function(){
            ...
            $('.bd_c4l ul li').click(function(){
                window.location.href="../html/information.html"+'?'+$(this).index();
            });

            $('.intro-block li').click(function(){
                window.location.href="../html/information.html"+'?'+($(this).index()-1);
            });

            $('#ul1 li').click(function(){
                window.location.href="../html/information.html"+'?'+($(this).index()+12);
            });

            $('#box li').click(function(){
                window.location.href="../html/information.html"+'?'+($(this).index()+16);
            })
});
